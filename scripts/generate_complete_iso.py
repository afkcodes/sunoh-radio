...
# Create two formats:
# 1. full_countries.json (Array of objects)
# 2. iso_mapping.json (Dictionary for fast lookup)

iso_dict = {item["name"]: item["code"] for item in raw_iso_data}

# Add some common aliases for our folder names that might not match exactly
aliases = {
    "UAE": "AE",
...
print(f"Generated countries_iso_map.json with {len(iso_dict)} aliases/mappings.")
