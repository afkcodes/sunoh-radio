-- 0001_init: base schema for radio_stations.
-- Idempotent (CREATE ... IF NOT EXISTS) so it is a no-op against an existing DB
-- and builds the full schema on a fresh one. NEVER drops data.
